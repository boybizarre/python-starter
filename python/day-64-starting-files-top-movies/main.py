...
MOVIE_DB_API_KEY = "c908b17632d99afd468f1cba769ab730"
...
def home():
    ...
    all_movies = results.scalars().all() # converts scalar results to python list
...
def find_movie():
    ...
    response = requests.get(f"{MOVIE_DB_INFO_URL}/{movie_id}", params=params)
