...
STOCK_API_KEY="G6QWARN63JRN5TD1"
NEWS_API_KEY="ec6e619d069e4c0dbf3c6925be6f5be7"
...
#TODO 5. - If TODO4 percentage is greater than 3 then print("Get News").
...
#TODO 7. - Use Python slice operator to create a list that contains the first 3 articles. Hint: https://stackoverflow.com/questions/509211/understanding-slice-notation
    three_articles = articles[:3] # getting the first three articles in the list 
